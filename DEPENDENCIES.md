...
```
mamba install -c conda-forge -c bioconda cd-hit prinseq-plus-plus bowtie2 bbmap samtools mmseqs2 seqtk
```
...
- [seqtk](https://github.com/lh3/seqtk) - install with conda: `mamba install seqtk`
